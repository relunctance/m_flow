"""
M-Flow MiniMax structured-output adapter.

Wraps MiniMax's Anthropic-compatible endpoint behind the common ``LLMBackend``
contract, using Instructor for schema-validated responses and Tenacity for
...
class MiniMaxAdapter(LLMBackend):
    """Structured-output adapter targeting MiniMax models.
    ...
    async def extract_structured(
        ...
        **kwargs,
        ...
        """Request a schema-validated response from MiniMax.
